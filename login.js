function openModal() {
	...
	myInput.onkeyup = function() {
       console.log(letter.classList);
        ...
        //I moved this part here so it will still turn the values green if you type in the password section as Well
        //if I remove this, the password match will still be valid if I erase the password section after matching
        //so I think this part of the code is needed
...
function enableButton(letter, capital, number, length, match) {
    ...
    if(condition) {
      ...
      //added a else statement so it disables the button again if the conditions are mismatched again
